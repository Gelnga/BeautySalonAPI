...
namespace WebApp.Areas.Admin.Controllers
{
    ...
    public class UnitsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,Id,Commentary")] Unit unit)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Name,Id,Commentary")] Unit unit)
        {
            if (id != unit.Id)
            {
                return NotFound();
